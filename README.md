...
## Overview
This repository demonstrates the end-to-end development of an actuarial **Frequency-Severity model** to analyze the impact of mileage, region, bonus class, and vehicle type on insurance claim frequencies and claim sizes.
